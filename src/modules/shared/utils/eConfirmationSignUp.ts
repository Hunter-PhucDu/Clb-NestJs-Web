const eConfirmationSignUp = (fullName: string): string => {
  return `
    <div
                                    ...
                                    <td>
                                        <div style="border-style:solid;border-width:thin;border-color:#dadce0;border-radius:8px;padding:20px 20px"
                                            ...
                                            <div
                                                ...
                                                <p>Đây là email xác nhận bạn đã đăng ký tài khoản thành công.<br></p>
                                                <p>Cảm ơn bạn đã đăng ký tham gia vào ngôi nhà của chúng tớ. Tham gia giao lưu cùng mình tại:</p>
                                                <div>
...
export default eConfirmationSignUp;
